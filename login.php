...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login page | E-Conter</title>
                                    ...
                                    <form class="form-horizontal mt-4 pt-2" action="" method="post">
                                        ...
                                        <div class="mb-3">
                                                <div class="form-check">
                                                    <input type="checkbox" name="ingat" class="form-check-input"
                                        ...
                                        <div>
                                            <button class="btn btn-primary w-100 waves-effect waves-light"
                                                type="submit" name="sumbit">Log In</button>
                                        </div>

                                        <div class="mt-4 text-center">
                                            <a href="resetpass.php" class="text-muted"><i class="mdi mdi-lock me-1"></i> Forgot your password?</a>
                                        </div>
